...
class SimulatedAckermannDrive:
    ...
    def __init__(self):
        ...
        wheel_rect = Rectangle(
            (0, 0), self.wheel_dim[0], self.wheel_dim[1], fc='none', ec='k', lw=1, rotation_point="center")
        self.wheel_rects = [self.ax.add_patch(copy.copy(wheel_rect)),
    ...
    def update_car_drawing(self):
        ...
        self.wheel_base_line.set_data([[x[0], front_axle_center[0]],
                            [x[1], front_axle_center[1]]])
        self.back_track_width_line.set_data([[wheel_centers[0][0], wheel_centers[1][0]], [
                                wheel_centers[0][1], wheel_centers[1][1]]])
        self.front_track_width_line.set_data([[wheel_centers[2][0], wheel_centers[3][0]], [
