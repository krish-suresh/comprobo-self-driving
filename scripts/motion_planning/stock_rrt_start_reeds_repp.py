...
from stock_rrt_star import RRTStar
...
class RRTStarReedsShepp(RRTStar):
    ...
    def steer(self, from_node, to_node):
        ...
        px, py, pyaw, mode, course_lengths = reeds_shepp_path.reeds_shepp_path_planning(
    ...
    def calc_new_cost(self, from_node, to_node):
        ...
        _, _, _, _, course_lengths = reeds_shepp_path.reeds_shepp_path_planning(
            from_node.x, from_node.y, from_node.yaw,
            to_node.x, to_node.y, to_node.yaw, self.curvature)
